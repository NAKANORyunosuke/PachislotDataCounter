#!/usr/bin/env bash
# Set up pico/.venv with mpremote — the official MicroPython tool used to
# push files (e.g. main.py) onto a Raspberry Pi Pico over USB serial.
#
...
Next:
  bash pico/scripts/flash.sh             # auto-detect Pico
